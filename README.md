...
- modo **Resolucao Guiada - Lista 11** para quando o aluno esta cansado: o app resolve a lista passo a passo, com imagem do exercicio, conclusao copiavel e blocos curtos explicando de onde saem trincas unicas, variaveis livres, parametros como \(t\), determinante zero e conjunto vazio \(S=\varnothing\);
